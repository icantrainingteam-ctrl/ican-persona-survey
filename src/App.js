              ...
              {!showCounselorView && (
                <div className="mt-8 flex justify-end">
                  <button 
                    ...
                    className="w-10 h-10 rounded-full bg-slate-200 hover:bg-slate-300 transition-colors flex items-center justify-center cursor-pointer text-slate-600 hover:text-slate-800 shadow-sm" 
